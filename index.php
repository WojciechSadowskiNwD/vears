<?php
session_start();
// import parametrow logowania do bazy
...
try{
    ...
    if($polaczenie->connect_errno!=0){
        ...
        if(isset($_POST['search-order'])){
            ...
            // Gdy wszystkie powyzsze testy zostaly zaliczone, nastepuje realizacja zapytania docelowego:
            if($validation_correct == true){
...
<head>
    ...
    <title>Vears - sklep odzieżowy</title>
...
<?php
// Jezeli wysłano nr zamowienia i nr telefonu:
if(isset($_POST['search-order'])){
            ...
            <?php
                ...
                for ($i = 1; $i <= $ile; $i++){
                    ...
                    echo "<div class='gray-section'>";
                      ...
                      echo "<table><tr>
                                <td class='td-product-num'>$y.</td>
                                <td class='td-product-name'> $product_name</td>
    ...
    <header>
        <div class="slider">
            <div class="slider-box">
                <figure class="slider-box__view">
                    <img class="slider-img slider-img__1 visible" src="./img/banners/banner_1.1.jpg"
                        alt="Zdjęcie reklamowe numer 1" />
                </figure>
                <figure class="slider-box__view">
                    <img class="slider-img slider-img__2 " src="./img/banners/banner_2.1.jpg"
                        alt="Zdjęcie reklamowe numer 2" />
                </figure>
                <figure class="slider-box__view">
                    <img class="slider-img slider-img__3 " src="./img/banners/banner_3.4.jpg"
                        alt="Zdjęcie reklamowe numer 3" />
                </figure>
            </div>
    ...
    <main>
        <section class="content-box">
            <div class="content-box__title">
                <h1>Odkryj swój niepowtarzalny styl</h1>
            </div>
            <div class="content-box__text">
                <p>Vears to miejsce, powstałe z pasji do mody, przeznaczone dla tych którzy lubią wyróżniać się stylem, a jednocześnie chcą podążać za najnowszymi trendami. Znajdziesz u nas znane, jak i zupełnie nowe marki. Stawiamy na różnorodność, dla tego każdy znajdzie tutaj coś dla siebie. Zaglądaj często aby nie przegapić świetnych okazji zakupowych!</p>
            </div>
        </section>
        <!-- produkty - wyswietlanie na male ekrany 1-->
        <section class="view-sample">
            <div class="view-sample__title">Nowości</div>
            <div class="view-sample__wrapper">
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=134">
                        <img class="rectangle-img"
                            src="./img/categories/woman/dresses/1sukienka-sciagany-rekaw-wiazany-dekolt-zielona_6.jpg"
                            alt="Zdjęcie produktu.">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">SUKIENKA SHERRY ZIELONA LABLANCO</p>
                            <p class="transparent-band__product-price">149,00 PLN</p>
                        </div>
                    </a>
                </figure>
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=60">
                        <img class="rectangle-img"
                            src="./img/categories/woman/dresses/Sukienka Zmarszczony Dytsi Kwiatowy Boho_1.jpg" alt="Zdjęcie produktu.">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">SUKIENKA TYPU A Z ZAKŁADKĄ I Z PASKIEM</p>
                            <p class="transparent-band__product-price">50,00 PLN</p>
                        </div>
                    </a>
                </figure>
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=133">
                        <img class="rectangle-img"
                            src="./img/categories/woman/pants/Damskie Spodnie Petite Tail_1.jpg" alt="Zdjęcie produktu.">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">Damskie Spodnie Petite Tail</p>
                            <p class="transparent-band__product-price">129,99 PLN</p>
                        </div>
                    </a>
                </figure>
            </div>
            <div class="view-sample__btn">
                <a href="./products.php?category=nowości">
                    <button class="view-sample__btn-look">ZOBACZ</button>
                </a>
            </div>
        </section>
        <!-- Produkty - wyswietlanie na wieksze ekrany 1-->
        <section class="view-sample-big">
            <div class="view-sample__title">Nowości</div>
            <div class="view-sample__wrapper">
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=1">
                        <img class="rectangle-img"
                            src="./img/categories/man/blouses/Bluza-meska-z-kapturem-czarna1-BX2028-8906_1.jpg" alt="">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">Bluza z kapturem czarna</p>
                            <p class="transparent-band__product-price">99,99 PLN</p>
                        </div>
                    </a>
                </figure>
                <figure class="view-sample__wrapper-rectangle">
        ...
        <section class="content-box">
            <div class="content-box__title">
                <h1>Sezon Letni czy może Zimowy</h1>
            </div>
            <div class="content-box__text">
                <p>Niezależnie od tego, w trakcie której pory roku gościsz na naszej stronie. Zawsze oferujemy świeże kolekcje dla Ciebie i Twoich bliskich!
                </p>
                <p>Zaopatrujemy nasz sklep w towar regularnie i na każdy sezon bez wyjątku. Niezależnie czy potrzebujesz modnej kurtki, czy letniej sukienki. Nie ma lepszego miejsca na zakupy niż Vears!</p>
            </div>
        </section>
        <!-- Produkty na mniejsze ekrany 1 -->
        <section class="view-sample">
            <div class="view-sample__title">Bestsellery</div>
            <div class="view-sample__wrapper">
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=234">
                        <img class="rectangle-img"
                            src="./img/categories/man/t_shirt/T-shirt męski bez nadruku czerwony TY289_1.jpg"
                            alt="T-shirt męski w trzy kolorowe pasy.Górna część czarna, środkowa czerwonego koloru i dolna siwego, bez nadruków ozdobnych.">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">T-shirt męski bez nadruku czerwony</p>
                            <p class="transparent-band__product-price">49,99 zł</p>
                        </div>
                    </a>
                </figure>
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=11">
                        <img class="rectangle-img" src="./img/categories/man/jackets/Kurtka męska Ombree X1302_1.jpg"
                            alt="Zdjęcie produktu.">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">Kurtka męska Ombree X1302</p>
                            <p class="transparent-band__product-price">224,00 PLN</p>
                        </div>
                    </a>
                </figure>
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=61">
                        <img class="rectangle-img"
                            src="./img/categories/woman/dresses/Sukienka koszulowa w kratę z falbaną_1.jpg" alt="Zdjęcie produktu.">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">Sukienka koszulowa w kratę z falbaną</p>
                            <p class="transparent-band__product-price">89,99 PLN</p>
                        </div>
                    </a>
                </figure>
            </div>
            <div class="view-sample__btn">
                <a href="./products.php?category=bestsellery">
                    <button class="view-sample__btn-look">ZOBACZ</button>
                </a>
            </div>
        </section>
        <!-- Produkty na większe ekrany 2 -->
        <section class="view-sample-big">
            <div class="view-sample__title">Bestsellery</div>
            <div class="view-sample__wrapper">
                <figure class="view-sample__wrapper-rectangle">
                ...
                <figure class="view-sample__wrapper-rectangle">
                    <a href="./product_details.php?idproduct=10">
                        <img class="rectangle-img" src="./img/categories/man/jackets/Kurtka męska Ombree B417Y_1.jpg"
                            alt="Zdjęcie produktu.">
                        <div class="transparent-band">
                            <p class="transparent-band__product-name">Kurtka męska Ombree B417Y</p>
                            <p class="transparent-band__product-price">154,99 PLN</p>
                        </div>
                    </a>
                </figure>
                <figure class="view-sample__wrapper-rectangle">
        ...
        <section class="view-sample view-sample--only-text">
            <div class="view-sample__title">Najpopularniejsze kategorie odzieży damskiej, męskiej</div>
        </section>
        <section class="photo-plates-section">
            <div class="photo-plates-section__large-plates">
                <a href="./products.php?category=sukienki">
                    <div class="single-large-plate single-large-plate--sample1">
            ...
            <div class="photo-plates-section__small-plates">
                <a href="./products.php?category=kurtki męskie">
                    <div class="single-small-plate single-small-plate--sample3">
                        <div class="sample-text">
                            <h1>Kurtki</h1>
                            <h2>Zobacz</h2>
                        </div>
                ...
                <a href="./products.php?category=spodnie męskie">
                    <div class="single-small-plate single-small-plate--sample4">
                        <div class="sample-text">
                            <h1>Spodnie</h1>
                            <h2>Zobacz</h2>
                        </div>
            ...
            <div class="photo-plates-section__large-plates">
                <a href="./products.php?category=bluzy męskie">
                    <div class="single-large-plate single-large-plate--sample2">
                        <div class="sample-text">
                            <h1>Bluzy</h1>
                            <h2>Zobacz więcej</h2>
                        </div>
