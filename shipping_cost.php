...
<head>
    ...
    <title>Vears - koszty przesyłki</title>
    ...
    <nav>
        ...
        <main>
            <section class="section-text">
                <h1 class="section-text__title">KOSZT I SPOSOBY DOSTAWY</h1>
                <div class="section-text__info ">
                    <i class="fa-solid fa-circle-info"></i>
                    Od kwoty koszyka 299zł dostawa jest darmowa !</div>
                <div class="table-delivery">
                    <div class="table-delivery__column">
                        <div class="table-delivery__column--header">
                            <h2>Forma dostawy</h2>
                        </div>
                        <div class="table-delivery__column--cell">
                            <figure>
                                <img src="./img/delivery logos/logo_Kurier_InPost.png" alt="logo InPost kurier">
                            </figure>
                        </div>
                        <div class="table-delivery__column--cell">
                            <figure>
                                <img src="./img/delivery logos/PL_logo_Paczkomat.jpg" alt="logo InPost paczkomaty">
                            </figure>
                        </div>
                        <div class="table-delivery__column--cell">
                            <figure>
                                <img src="./img/delivery logos/logo-dpd-kurier.jpg" alt="logo kurier DPD">
                            </figure>
                        </div>
                        <div class="table-delivery__column--cell">
                            <figure>
                                <img src="./img/delivery logos/logo-pocztex-kurier.jpg" alt="logo kurier DPD">
                            </figure>
                        </div>
                    </div>
                    <div class="table-delivery__column">
