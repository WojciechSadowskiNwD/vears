...
try{
    ...
    if($polaczenie->connect_errno!=0){
        ...
        if(isset($_POST['search-order'])){
            ...
            // Jezeli wszystkie powyzsze testy zostaly zaloczone, realizuje sie docelowe zapytanie:
            if($validation_correct == true){
...
<head>
    ...
    <title>Vears - zwroty i reklamacje</title>
...
<?php } ?> 
    ...
    <main>
        <div class="section-text">
            <h1 class="section-text__title">Zwroty i reklamacje</h1>
            <h2>ZWROTY</h2>
            <p>W przypadku, gdy klient dokonał zakupu, a po przymierzeniu, oberzeniu produktu nie spełnia on oczekiwań
                istnieje możliwość dokonania zwrotu do 14 dni od momentu odebrania przesyłki. Wówczas zwrot wpłaconych
                środków nastąpi nie później niż 7 dni roboczych od otrzymania zwrotu zakupionego towaru.</p>
            <p>Aby dokonać zwrotu należy odesłać produkt na adres firmy:
            <span>VEARS - magazyn 88-111 Testowo, ul. Sezamowa 5</span></p>

            <p>* Należy także dołączyć wypełniony<strong> formularz zwrotu</strong> i potwierdzenie zamówienia, które
                klient otrzymał drogą mailową. </p>
            <h2>REKLAMACJA</h2>
            <p>Jeżeli otrzymany produkt, posiada wady, można zwrócić produkt w ramach reklamacji. Ważne aby było to nie później niż 24 godziny od odebrania przesyłki. Wówczas to my poniesiemy koszt nadania paczki.</p>
            <p>Adres do dokonania zwrotu reklamacyjny jest taki sam jak powyżej.</p>
            <p>* Należy także dołączyć wypełniony<strong> formularz reklamacji</strong> i potwierdzenie zamówienia,
                które klient otrzymał drogą mailową. </p>
            <h2 class="underline">WAŻNE</h2>
            <p>Niezależnie czy jako klient wysyłasz zwrot czy reklamację, prosimy aby pamiętać o podstawowych zasadach:
            </p>
            <ul class="extra-margin">
                <li>Prosimy o właściwe zabezpieczenie przesyłki przed jej zniszczeniem. Natomiast obuwie musi zostać zwrócone w oryginalnym kartonie.</li>
                <li>Reklamowany produkt powinien być wolny od zabrudzeń.</li>
                <li>W przypadku uznanej reklamacji, uszkodzony produkt zostanie naprawiony albo wymieniony na ten sam, pełnowartościowy produkt. Jeśli będzie to niemożliwe, zwrócimy jego koszt.</li>
                <li>W przypadku pozytywnego rozpatrzenia reklamacji, zwracamy równowartość najtańszego kosztu wysyłki
                    dostępnego na naszej stronie internetowej.</li>
                <li>Forma zwrotu środków jest zależna od metody płatności. </li>
                <li>Nie przyjmujemy zwrotów wysyłanych za pobraniem oraz wysłanych do paczkomatu.</li>
            </ul>

            <div class="section-download">
                <div class="section-download__text">
                    <p>Pobierz formularz
                ...
                <div class="section-download__box">
                    <div class="download-file">
                        <a href="./download/VEARS.pl_Formularz_zwrotu.pdf" download="./download/VEARS.pl_Formularz_zwrotu.pdf" alt="link do pobrania formularza zwrotu towaru">
                ...
                <div class="section-download__box">
                    <div class="download-file">
                        <a href="./download/VEARS.pl_Formularz_reklamacji.pdf" download="./download/VEARS.pl_Formularz_reklamacji.pdf" alt="link do pobrania formularza reklamacji towaru">
                            <i class="fa-solid fa-file-pdf"></i>
                            <p>reklamacja PDF</p>
                        </a>
                    </div>
