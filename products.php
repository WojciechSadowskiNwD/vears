...
try{
    ...
    if(!isset($_POST['phrase']) && isset($_GET['category'])){
        $category = $_GET['category'];
        $sql = "SELECT * FROM products WHERE category LIKE '%".$category."%'";
    }else{
        $phrase = $_POST['phrase'];
        $sql = "SELECT * FROM products WHERE nameProduct LIKE '%".$phrase."%'";
    }
}catch(Exception $e){
...
<head>
    ...
    <title>Vears - wyszukiwanie produktów</title>
...
<?php } ?> 
    ...
    <main>
        <div class="section-products">
            <?php
                if($category == '' && $phrase == ''){
                    echo '<h1 class="section-products__title">WSZYSTKIE PRODUKTY</h1>';
                }else if(isset($_POST['phrase'])){
                    echo '<h1 class="section-products__title">Rezultat wyszukiwania: '. $phrase .'</h1>';
                }else{
                    echo '<h1 class="section-products__title">'. $category .'</h1>';
                } ?>
            <div class="section-products__products">
                <?php 
                    ...
                    echo<<<END
                    <a href="./product_details.php?idproduct=$idproduct">
                        <figure>
                            <div class="product-box">
                                <img class="product-box__img" src="$pictureA" alt="fotografia produktu">
                                <div class="transparent-band">
                                    <p class="transparent-band__product-name">$nameProduct</p>
                                    <p class="transparent-band__product-price">$newPrice PLN</p>
                                </div>
                            </div>
                        </figure>
                    </a>
