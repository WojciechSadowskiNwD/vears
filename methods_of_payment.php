    ...
    if($polaczenie->connect_errno!=0){
        ...
        if(isset($_POST['search-order'])){
            ...
            if($validation_correct == true){
                //C. Sprawdzenie czy numer zamowienia istnieje w bazie:
...
<head>
    ...
    <title>Vears - metody płatności</title>
...
<body>
    ...
    <!-- Wyszukiwanie zamowienia -->
<?php
// Gdy wysłano nr zamowienia i nr telefonu:
if(isset($_POST['search-order'])){
...
<?php } ?> 
    ...
    <main>
        <div class="section-text ">
            <h1 class="section-text__title">Formy płatności</h1>
            <div class="section-text__box section-text__box--first">
                <div class="section-text__box--img">
                    <figure>
                        <img src="./img/pay logos/PAYU_LOGO.png" alt="logo metody płatności szybki przelew payU">
                    </figure>
                </div>
                <div class="section-text__box--content">
                    <h2 class="bold">Szybki przelew PayU</h2>
                    <p class="paragraph-pay">Najczęściej wybierana forma płatności online w Polsce. Ty dokonujesz płatności w kilka sekund, a my niemal natychmiast widzimy jej księgowanie. dzięki temu jesteśmy gotowi praktycznie od razu przejść do realizacji zamówienia nie tracąc czasu.</p>
                </div>
            </div>
            <div class="section-text__box">
                <div class="section-text__box--img">
                    <figure>
                        <img src="./img/pay logos/blik.png" alt="logo metody płatności szybki przelew payU">
                    </figure>
                </div>
                <div class="section-text__box--content">
                    <h2 class="bold">BLIK</h2>
                    <p class="paragraph-pay">Błyskawiczna płatności bezgotówkowa. Nowoczesny sposób płatności online, dla użytkowników urządzeń mobilnych. Wystarczy wpisać sześciocyfrowy kod dostępny w mobilnej aplikacji bankowej w osobistym smartfonie, następnie potwierdzić i gotowe, księgowanie również jest natychmiastowe, a potwierdzenie otrzymujesz na maila.</p>
                </div>
            </div>
            <div class="section-text__box">
                <div class="section-text__box--img">
                ...
                <div class="section-text__box--content">
                    <h2 class="bold">Przelew zwykły</h2>
                    <p class="paragraph-pay">
                        Standardowa metoda płatności, zwykłym przelewem bankowym. Podczas składania zamówienia zostaje wygenerowany druk, zawierający wszelkie dane potrzebne do wykonania płatności. Można wydrukować go i zapłacić w banku albo przepisać dane w formularzu płatności online w swoim banku. W tym przypadku księgowanie trwa około 3 dni roboczych.</p>
                </div>
            </div>
        </section>
    </main>
