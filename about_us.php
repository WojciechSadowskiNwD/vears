...
try{
    ...
    if($polaczenie->connect_errno!=0){
        ...
        if(isset($_POST['search-order'])){
            ...
            //Gdy wszystkie powyższe testy zostaly zaliczone, realizujemy docelowe zapytanie:
            if($validation_correct == true){
...
<?php } ?> 
    ...
    <main>
        <div class="section-text">
            <h1 class="section-text__title">O VEARS</h1>
            <div class="about-us-container">
                <div class="about-us-container__box">
                    <p>
                        <span class="content-title">Nasza misja - </span>
                        Jako ludzie podążający za swymi pasjami, połączyliśmy nasze siły tworząc wspaniały team ludzi
                        pragnących dostarczyć na rynku Polskim najnowszych dzieł świata mody. Z ogromnym zaangażowaniem
                        pracujemy nad tym by nasz sklep stał się synonimem piękna, stylu i najwyższej jakości.
                        Nieustannie nawiązujemy kolejne współprace z tymi markami, które cechują się nienagannym
                        wykonaniem swoich produktów, świetnym wyglądem oraz zaufaniem na rynku. Promujemy też mniej
                        znanych producentów, jeśli uznajemy że dokładnie tego potrzebują nasi klienci zważywszy na wciąż
                        zmieniające się trendy modowe.
                    </p>
                </div>
                <div class="about-us-container__box">
                    <figure>
                        <img class="about-us-container__box-img" src="./img/about_us_photos/team-hands_640.jpg"
                            alt="Zdjęcie przedstawiające grupę kilkoro osób trzymających się za ręce.">
                    </figure>
                </div>
            </div>
            <div class="about-us-container">
                <div class="about-us-container__box--third">
                    <figure>
                        <img class="about-us-container__box-img" src="./img/about_us_photos/man_woman.jpg"
                            alt="Para mężczyzna i kobieta leżą zrelaksowani patrząc sobie w oczy.">
                    </figure>
                </div>
                <div class="about-us-container__box--fourth">
                    <p>
                        <span class="content-title">Dlaczego właśnie my ? - </span>
                        Gdyż u nas właśnie znajdziesz wspaniałe kreacje <strong>dla niej i dla niego</strong>, jak
                        również dla swoich bliskich na prezent. Specjalizujemy się zarówno w męskiej modzie jak i
                        damskiej w dodatku sezonowo. Niezależnie w jakim jesteś wieku, znajdziesz tu swój indywidualny
                        styl. Zamawiaj bez obaw, jeśli ubranie nie będzie pasować możesz je zwrócić bez podawania
                        przyczyny. Vears to miejsce modowe na każdy gust i każdą kieszeń. Pamiętaj że dostawa od kwoty
                        299zł wzwyż jest całkowicie darmowa.
                    </p>
                </div>
            </div>
            <div class="about-us-container about-us-container--last">
                <div class="about-us-container__box">
                    <p>
                        <span class="content-title">Gwarancja profesjonalnej obslugi - </span>
                        Współpracujemy tylko z najlepszymi. Dla tego właśnie możesz liczyć na szybką dostawę towaru,
                        sprawnej realizacji Twojej reklamacji lub zwrotu towaru. Jeżeli masz jakieś pytania, proszę
                        dzwoń śmiało a nasi pracownicy chętnie pomogą na każdym etapie zakupów bądź zakładania konta.
                        Załuż konto u nas i ciesz się nową jakością podejścia do klienta, na którego zadowoleniu
                        najbardziej nam zależy! Tak więc kliknij KUPUJĘ i zrelaksuj się, my zadbamy o resztę. Miej
                        wspaniały dzień z VEARS.
                    </p>
                </div>
                <div class="about-us-container__box">
                    <figure>
                        <img class="about-us-container__box-img" src="./img/about_us_photos/woman-1274361_640.jpg"
                            alt="Uśmiechnięta kobieta owinięta kolorowym szalem w kratę">
                    </figure>
                </div>
            </div>
        </div>
